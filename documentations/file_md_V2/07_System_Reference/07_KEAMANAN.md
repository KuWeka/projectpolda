...
Sumber Asli: dokumentasi_final/07_KEAMANAN.md
...
1. Ringkasan Lapisan Keamanan
2. 1. Autentikasi JWT (OWASP A07: Identification & Authentication)
3. Access Token
4. Refresh Token
5. Keamanan Cookie
6. 2. CSRF Protection (OWASP A01: Broken Access Control)
7. 3. Rate Limiting (OWASP A04: Insecure Design)
8. 4. Input Validation (OWASP A03: Injection)
