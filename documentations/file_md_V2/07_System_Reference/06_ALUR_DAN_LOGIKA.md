...
Sumber Asli: dokumentasi_final/06_ALUR_DAN_LOGIKA.md

## Tujuan Dokumen

[User membuka aplikasi] │ ▼ [Cek localStorage: app_theme] ← set default dark → │ ▼ [Cek cookie: helpdesk_access_token] ┌────┴────┐ │         │ Ada      Tidak ada │         │ ▼         ▼ [Verify   [Redirect ke JWT via   /login] /api/auth/me] │
...
2. Detail Mekanisme Token
3. 2. Alur Pembuatan Tiket
4. Aturan Nomor Tiket
5. 3. Alur Penanganan Tiket oleh Teknisi
6. 4. Alur Chat Real-time
7. 5. Alur Manajemen Pengguna oleh Admin
8. 6. Alur Caching Dashboard
