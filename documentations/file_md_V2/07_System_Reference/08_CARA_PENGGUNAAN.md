...
Sumber Asli: dokumentasi_final/08_CARA_PENGGUNAAN.md

## Tujuan Dokumen

| Software    | Versi Minimum | Keterangan                          | |-------------|---------------|-------------------------------------| | Node.js     | 18.x LTS      | Runtime JavaScript                  | | npm         | 9.x           | Package manager                     |
...
3. Setup Awal (Fresh Install)
4. Langkah 1: Clone & Install Dependencies
5. Langkah 2: Konfigurasi Environment Backend
6. Langkah 3: Setup Database
7. Langkah 4: Jalankan Aplikasi (Development)
8. Langkah 5: Akses Aplikasi
