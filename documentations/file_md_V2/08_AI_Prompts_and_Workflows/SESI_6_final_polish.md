...
Sumber Asli: promt/SESI_6_final_polish.md

## Tujuan Dokumen

> Jalankan setelah Sesi 5 selesai > Fokus: Perbaikan sisa, konsistensi, dan verifikasi akhir seluruh aplikasi
...
3. TUGAS SESI INI
4. TUGAS 1 — Scan seluruh project, cari dan ganti token CSS yang tidak valid
5. TUGAS 2 — Konsistenkan page title di semua halaman
6. TUGAS 3 — Konsistenkan Skeleton loading di semua halaman tabel
7. TUGAS 4 — Tambahkan empty state di semua tabel
8. TUGAS 5 — Verifikasi `src/components/layout/header.jsx`
