# SESI 4 Form Login Settings

Tanggal Dokumen: 2026-04-23
Versi Dokumen: V2 Professional
Sumber Asli: promt/SESI_4_form_login_settings.md

## Tujuan Dokumen

> Jalankan setelah Sesi 3 selesai dan diverifikasi > Fokus: Rapikan halaman Login, Signup, dan semua halaman Settings
...
3. TUGAS SESI INI
4. TUGAS 1 — `src/pages/LoginPage.jsx`
5. 1A. Tambahkan animasi masuk
6. 1B. Perbaiki error display
7. 1C. Pastikan button submit punya loading state yang benar
8. TUGAS 2 — `src/pages/SignupPage.jsx`
