...
Sumber Asli: promt/SESI_5_chat_tiket.md

## Tujuan Dokumen

> Jalankan setelah Sesi 4 selesai dan diverifikasi > Fokus: UI chat (ScrollArea, bubble), halaman tiket, dan ticket detail
...
3. TUGAS SESI INI
4. TUGAS 1 — `src/components/ChatMessage.jsx`
5. 1A. Ganti `bg-surface` (tidak ada di theme baru) dengan token yang valid
6. 1B. Pastikan read receipt icon konsisten
7. TUGAS 2 — `src/components/MessageInput.jsx`
8. TUGAS 3 — `src/pages/technician/TechnicianChatsPage.jsx`
