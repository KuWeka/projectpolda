# SESI 3 Tabel Modal Alertdialog

Tanggal Dokumen: 2026-04-23
Versi Dokumen: V2 Professional
Sumber Asli: promt/SESI_3_tabel_modal_alertdialog.md

## Tujuan Dokumen

> Jalankan setelah Sesi 2 selesai dan diverifikasi > Fokus: Konsistenkan halaman tabel, refactor modal, ganti window.confirm
...
3. TUGAS SESI INI
4. TUGAS 1 — Ganti semua `window.confirm` dengan `AlertDialog`
5. TUGAS 2 — Refactor `src/components/AddEditTechnicianModal.jsx`
6. TUGAS 3 — Refactor `src/components/UserEditModal.jsx`
7. TUGAS 4 — Tambahkan action `DropdownMenu` per baris tabel
8. TUGAS 5 — Konsistenkan page header di semua halaman tabel
