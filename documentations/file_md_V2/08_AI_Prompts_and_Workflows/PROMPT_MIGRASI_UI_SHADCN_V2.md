# PROMPT MIGRASI UI SHADCN V2

Tanggal Dokumen: 2026-04-23
Versi Dokumen: V2 Professional
Sumber Asli: promt/PROMPT_MIGRASI_UI_SHADCN_V2.md

## Tujuan Dokumen

> Untuk: GitHub Copilot Agent / Cursor AI / Windsurf / AI Agent lainnya > Stack: React 18 + Vite + TailwindCSS v3 + shadcn/ui + Axios + Socket.io > Tujuan: Selesaikan dan konsistenkan UI layer menggunakan shadcn/ui ecosystem sepenuhnya
...
2. ✅ Yang SUDAH selesai (JANGAN diubah):
3. ❌ Yang BELUM selesai (ini yang harus dikerjakan):
4. 🎯 TEMPLATE ACUAN VISUAL
5. 🚫 LARANGAN KERAS — JANGAN SENTUH
6. ✅ SCOPE PEKERJAAN — URUTAN PENGERJAAN
7. LANGKAH 1 — Bersihkan duplikasi layout
8. LANGKAH 2 — Selesaikan komponen `layout/` yang masih belum sempurna
