# Phase 4: Staging Deployment and Release Automation Guide

Phase 4 focuses on making releases repeatable and low-risk through automated deployment, smoke verification, and rollback controls.
...
- DB backup script from phase 3 retained for release safety: `backend/scripts/backup-db.js`
